                            ...
                            <div class="fc-content" style="position: relative;">
                                <div class="fc-view fc-view-month fc-grid" style="position:relative" unselectable="on">
                                    ...
                                    echo "<div class='fc-event-container' style='position:absolute;z-index:8;top:0;left:0'>
                                       ...
                                       echo ";'>
                                            <a href='../medecin/index.php?p=notification' style='color: white;'><div class='fc-event-inner'>
                            ...
                            <div class="fc-content" style="position: relative;">
                                <div class="fc-view fc-view-month fc-grid" style="position:relative" unselectable="on">
                                    ...
                                    echo "<div class='fc-event-container' style='position:absolute;z-index:8;top:0;left:0'>
                                       ...
                                       echo ";'>
                                            <a href='../medecin/index.php?p=rdv_v' style='color: white;'><div class='fc-event-inner'>
                                                <span class='fc-event-title'>"; 
                                       ...
                                       echo ";'>
                                            <a href='../medecin/index.php?p=rdv_d' style='color: white;'><div class='fc-event-inner'>
                                                <span class='fc-event-title'>";
                                                $requete2 = $bdd->prepare('SELECT NOM_M FROM medecin WHERE MEDECIN_ID=?');
                                                $requete2->execute(array($donnees['MEDECIN_ID']));
                                                while($donnees2 = $requete2->fetch()) { $nomp=$donnees2['NOM_M'];}
                                ...
                                <div class="fc-view fc-view-month fc-grid" style="position:relative" unselectable="on">
                                   <?php
                                    ...
                                    echo "<div class='fc-event-container' style='position:absolute;z-index:8;top:0;left:0'>
                                       ...
                                       echo ";'>
                                            <a href='../medecin/index.php?p=emploi_temps' style='color: white;'><div class='fc-event-inner'>
                                                <span class='fc-event-title'>";  
                                                echo $donnees['NOM_M'] ." ". $donnees['TEMPS_d_emp']  ." - ". $donnees['TEMPS_f_emp'] ."<br></span>
                                            </div></a>
                                        </div>
                                        </div>";
