<?php
	...
	$stmt = $auth_user->runQuery("SELECT * FROM receptionniste WHERE RECEPTION_ID=:user_id");
...
<html lang="en">
    <head>
        ...
        <title>Login | Réceptionniste</title>
...
<?php
                ...
                if (isset($_GET['p'])){
                    ...
                    if ($page=="rapport_deces") $nom="Rapport de décès";
                    if ($page=="patient") $nom="Patient";
                    if ($page=="notification") $nom="Notification";
                    if ($page=="emploi_temps") $nom="Emploi temps";
                    if ($page=="medecin") $nom="Médecin";
