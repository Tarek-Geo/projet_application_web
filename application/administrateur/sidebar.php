  <div class="sidebar-menu" style="min-height: 643px;">
    <header class="logo-env" style="">
        ...
        <div class="logo" style="">
            <a href="../administrateur/index.php?p=tableau_de_board">
    ...
    <div class="sidebar-user-info">
        ...
        <div class="sui-normal">
            <a href="#" class="user-link">
                <img src="../assets/images/admin.png" alt="" class="img-circle" style="height:44px;">
    ...
    <ul id="main-menu" class="" style="">
        ...
        <li class="<?php if ($page=="service") echo "active";?> root-level">
            <a href="?p=service">
        ...
        <li class="<?php if ($page=="medecin") echo "active";?> root-level">
            <a href="?p=medecin">
                <i class="fa fa-user-md"></i>
                <span style="">Médecin</span>
            </a>
        </li>
        ...
        <li class="<?php if ($page=="infirmiere") echo "active";?> root-level">
            <a href="?p=infirmiere">
                <i class="fa fa-user"></i>
                <span style="">Infirmier</span>
            </a>
        </li>
        ...
        <li class="root-level has-sub">
            ...
            <ul style="">
                <li class=" <?php if ($page=="parametres_systeme") echo "active";?> ">
                    <a href="?p=parametres_systeme">
                        <span style=""><i class="fa fa-h-square"></i> Paramètres Système</span>
                    </a>
                </li>
