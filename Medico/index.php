...
<body id="top">
        ...
        <section class="navigation">
            <header>
                <div class="header-content">
                    <div class="logo"><a href="#"><img src="img/medico.png" alt="Sedna logo"></a></div>
                    <div class="header-nav">
                        <nav>
                            <ul class="primary-nav">
                                <li><a href="#features">Fonctionnalités</a></li>
                                <li><a href="#assets">Activités</a></li>
                                <li><a href="#download">À propos</a></li>
                            </ul>
                            <ul class="member-actions">
                                <li><a href="../application/login.php" class="btn-white btn-small">S'identifier</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div class="navicon">
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="hero-content text-center">
                        <h1>Medico</h1>
                        <p class="intro">C'est une application web pour.Gestion du personnel medical</p>
                        <a href="#" class="btn btn-accent btn-large">Plus</a>
                    </div>
                </div>
            </div>
        </div>
   ...
   <section class="intro section-padding">
    ...
    <section class="hero-strip section-padding" id="download">
        <div class="container">
